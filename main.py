...
async def create_key(
    ...
    cur.execute("""
        ...
        VALUES (%s, %s, %s, %s, %s)
    """, (name, key, max_devices, expires_at, datetime.now()))
    conn.commit()
    cur.close()
    conn.close()
